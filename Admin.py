...
# -------------------------------------------------
__AUTHOR__ = 'NAL'
__TELEGRAM_ID__ = '@NaldyDjafar'
__INSTAGRAM_ID__ = '@naldjfr_'
__GITHUB__ = 'https://github.com/NaldyDjafar'
__COMMENT__ = '''NULL'''
...
print(Fore.WHITE+'['+Fore.RED+'#'+Fore.WHITE+'] Masukan URL Target Example: google.com (Bersama http or https or www !)')
